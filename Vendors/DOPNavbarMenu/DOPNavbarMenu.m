...
- (void)layoutSubviews {
    ...
    [self.items enumerateObjectsUsingBlock:^(DOPNavbarMenuItem *obj, NSUInteger idx, BOOL *stop) {
        ...
        button.frame = CGRectMake(buttonX, buttonY+10, buttonWidth, buttonHeight);
        button.tag = idx;
        ...
        UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0, buttonHeight-30, buttonWidth, 0)];
